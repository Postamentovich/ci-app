...
const SettingsPage = () => {
  ...
  const handleClearRepoName = useCallback(
    () => dispatch(settingsSlice.actions.changeRepoName('')),
    [dispatch],
  );
   ...
   */
  const handleClearBuildCommand = useCallback(
    () => dispatch(settingsSlice.actions.changeBuildCommand('')),
    [dispatch],
  );
   ...
   */
  const handleClearMainBranch = useCallback(
    () => dispatch(settingsSlice.actions.changeMainBranch('')),
    [dispatch],
  );
  ...
  const handleChangePeriod = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (/\d+/.test(Number(e.target.value))) {
        dispatch(settingsSlice.actions.changePeriod(Number(e.target.value)));
      }
    },
    [dispatch],
  );
